...
class Player {
  ...
  draw(ctx) {
    if (this.facing === 0) {
      this.animations[0].drawFrame(this.game.clockTick, ctx, this.x, this.y, 0.5)
    } else if (this.facing === 1) {
      this.animations[1].drawFrame(this.game.clockTick, ctx, this.x, this.y, 0.5)
    } else if (this.facing === 2) {
      this.animations[2].drawFrame(this.game.clockTick, ctx, this.x, this.y, 0.5)
    } else {
      this.animations[3].drawFrame(this.game.clockTick, ctx, this.x, this.y, 0.5)
    }
  }
